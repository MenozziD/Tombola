...
public class ActivityMain  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        for (int i = 0;i<90; i++){
            ...
            f.setLayoutParams(new FrameLayout.LayoutParams(dpToPx(45),dpToPx(32)));
            ...
            casella.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            casella.setBackgroundResource(outValue.resourceId);
            casella.setScaleType(ImageButton.ScaleType.CENTER_CROP);
